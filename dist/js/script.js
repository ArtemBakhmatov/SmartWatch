...
function modalCardChildren() {
    function modalCardRender(image1, image2, image3, titleModal, color1, color2, color3, firm, forWhom, numberStars, numberReviews, priceOld, priceNew, availability) {
        ...
        document.querySelector('.hits').append(modalCard);
        ...
        //const itemArr = ['Описание', 'характеристики', 'отзывы (6)', 'доставка и оплата', 'Частые вопросы'];
        ...
        item3.textContent = `отзывы (${numberStars})`;
        items.append(item3);
        ...
        itemBlock5.innerHTML = `
            <div class="modalCard__questions">
    ...
    /////////////////////////// slider ////////////////////////////
        ...
        const tabArr = [];
        tabArr.push(tab1, tab2, tab3);

        const tabImgArr = [];
        tabImgArr.push(tabImg1, tabImg2, tabImg3);
        ...
        //     imgArr[i].classList.add('show', 'fade');
        //     imgArr[i].classList.remove('hide');
        //     tabArr[i].classList.add('modalCard__tab-active');
        //     tabImgArr[i].classList.add('modalCard__tab-img__active');
        //     tabsTextColorArray[i].classList.add('show');
        //     tabsTextColorArray[i].classList.remove('hide');
        // }
        // hideTabSlides();
...
/* harmony import */ var _modules_tabsCards__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/tabsCards */ "./src/js/modules/tabsCards.js");
/* harmony import */ var _modules_modalCard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/modalCard */ "./src/js/modules/modalCard.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_tabsCards__WEBPACK_IMPORTED_MODULE_9__["tabsCards"])();
    Object(_modules_modalCard__WEBPACK_IMPORTED_MODULE_10__["modalCard"])();
});
